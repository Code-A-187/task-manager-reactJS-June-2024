  ...
  return (
    <header className='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
        <section className="bg-[#004d66] px-4 py-0.5 sm:px-10 flex items-center max-sm:flex-col">
            ...
            <a href="#" className="text-white text-sm mr-1 text-gray-300 hover:text-white">Sign In</a>
            /
            <a href="#" className="text-white text-sm ml-1 hover:text-white text-gray-300 hover:text-white">Sign Up</a>
        </div>
        </section>

        <div className='flex bg-[#121533] min-h-[50px] flex-wrap items-center justify-between gap-4 w-full'>
        <a href="#"><img src="" alt="Task Manager" className='w-36' />
        </a>
