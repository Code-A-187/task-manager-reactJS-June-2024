  ...
  return (
    <nav className="bg-[#121e31] h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] tracking-wide overflow-auto z-40">
            ...
            <ul className="space-y-3">
                <li>
                    <Link to="/all-tasks" className="text-white text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                ...
                <li>
                    <Link to="/important-tasks" className="text-white text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                ...
                <li>
                    <Link to="/completed-tasks" className="text-white text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                ...
                <li>
                    <Link to="now-tasks" className="text-white text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                        viewBox="0 0 682.667 682.667">
