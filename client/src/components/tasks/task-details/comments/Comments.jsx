        ...
        {comments.slice().reverse().map(comment => (
            <div key={comment._id} className="border rounded-md p-3 ml-3 my-3">
                ...
                <div className="flex items-center text-xs font-medium text-gray-400">
                    <svg
                    className="w-4 h-4 text-gray-300 fill-current mr-1"
                    ...
                    {new Date(Number(comment._createdOn)).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric'
                    })}
                ...
                <h3 className="font-bold text-sm mt-1">{comment.author.fullName}</h3>
                </div>
