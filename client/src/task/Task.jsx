...
export default function Task() {
  ...
  return (
    ...
    <span className="flex items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full">Important</span>
        <h4 className="mt-3 text-sm font-medium">React API for SoftUni</h4>
    <div className="flex items-center w-full mt-3 text-xs font-medium text-gray-400">
        <div className="flex items-center">
            ...
            <span className="ml-1 leading-none">Aug 08</span>
        </div>
        <div className="relative flex items-center ml-4">
            ...
            <span className="ml-1 leading-none">5</span>
        </div>
